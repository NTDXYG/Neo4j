...
import com.example.hanlp.process.ModelProcess;
...
class HanlpApplicationTests {
    ...
    public void TestC() throws Exception{
        ModelProcess query = new ModelProcess("D:\\BaiduNetdiskDownload\\data-for-1.7.5\\data");
